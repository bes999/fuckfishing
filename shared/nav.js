...
/* =========================================================
   AppNav — нижний навбар. Статичный набор из 3 вкладок —
   не переключается по режимам, поэтому из любой точки
   приложения всегда виден путь домой/к планам/в текущую
   поездку. Профиль убран отсюда — он уже открывается тапом
   по аватару в шапке (AppHeader), дублировать вход не нужно.
   Всё остальное (Гид->Реки/Меню/Улов/..., Бар, Аптечка,
   Снаряга и т.д.) — в выезжающем меню AppHeader.
   ========================================================= */
var AppNav = (function () {
